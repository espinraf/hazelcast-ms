...
public class ASCIIArtGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println();
        artGen.printTextArt("Spring boot Rocks !!!!!", ASCIIArtGenerator.ART_SIZE_SMALL);
        System.out.println();

        System.out.println();
        artGen.printTextArt("Spring Framework No 1", ASCIIArtGenerator.ART_SIZE_SMALL, ASCIIArtFont.ART_FONT_MONO,"@");
        System.out.println();
